...
## Проблема с Docker образами

Оригинальные Dockerfile используют недоступные bitnami образы. Исправления:

```bash
# Dashboard - уже исправлен
# kubeapps-apis - исправлен частично

# Альтернативный подход - локальная разработка без Docker
```
